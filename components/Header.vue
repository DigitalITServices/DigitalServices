              ...
              <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                <div class="pt-5 pb-6 px-5">
                  <div class="flex items-center justify-between">
                    ...
                    <div class="-mr-2">
                      <button type="button" @click="isOpen = !isOpen" class="rounded-md p-2 inline-flex items-center justify-center hover:text-gray-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-600">
                        <span class="sr-only">Open menu</span>
